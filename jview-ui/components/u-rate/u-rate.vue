 ...
 * @tutorial https://www.jViewui.com/components/rate.html
 ...
 * @property {String} active-icon 选中时的图标名，只能为jView的内置图标（默认star-fill）
 * @property {String} inactive-icon 未选中时的图标名，只能为jView的内置图标（默认star）
