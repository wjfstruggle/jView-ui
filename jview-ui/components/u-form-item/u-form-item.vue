...
<script>
	 ...
	 * @tutorial http://jViewui.com/components/form.html
	 ...
	 * @property {String} right-icon 右侧自定义字体图标(限jView内置图标)或图片地址
	 * @property {String} left-icon 左侧自定义字体图标(限jView内置图标)或图片地址
