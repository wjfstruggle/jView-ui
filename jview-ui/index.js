...
// 尝试判断在根目录的/store中是否有$u.mixin.js，此文件jView默认为需要挂在到全局的vuex的state变量
...
// 主题相关颜色,info|success|warning|primary|default|error,此颜色已在jView.scss中定义,但是为js中也能使用,故也定义一份
